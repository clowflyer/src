...
jsPsych.plugins['irbform'] = (function() {

  var plugin = {};

  plugin.trial = function(display_element, trial) {

    var plugin_id_name = "jspsych-irbform";
    ...
    trial = jsPsych.pluginAPI.evaluateFunctionParameters(trial);
     ...
     // display stimulus
    if (!trial.is_html) {
      // display_element.append('<img src="html5.gif" alt="HTML5 Icon" width="128" height="128">')
    ...
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      $(question_selector).append(
        '<p class="' + plugin_id_name + '-text irbform">' + trial.questions[i] + '</p>'
      );
    ...
    $trial_form.submit(function(event) {
	  ...
	  if(question_data.Q0 == 'I do not consent to participate in the study'){
         jsPsych.endExperiment('You did not consent to participate in the study.')
      }
